...
to buildmaze
  ...
  repeat mazesize [
    let pset patches with [ pcolor = black and count neighbors4 with [pcolor = white] = 1]
    if any? pset [
      ask one-of pset [set pcolor white]
    ]
  ]

  let pset patches with [pcolor = black and count neighbors4 with [pcolor = white] = 1]
  if any? pset [
    ask one-of pset [set pcolor red]
  ]
...
to go
  ...
  ask turtles [
    ifelse any? neighbors4 with [pcolor = red][
      forward 0
      face one-of neighbors4 with [pcolor = red ]
